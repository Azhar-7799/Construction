...
const NotFound = () => (
  <>
    <SEO title="Page Not Found | Crown Home Spaces" description="The page you are looking for cannot be found. Return to the construction interior home page." />
    <section className="min-h-[calc(100vh-160px)] px-4 py-24 sm:px-6 lg:px-8">
