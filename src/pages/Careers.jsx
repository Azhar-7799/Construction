      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-lg leading-8 text-crown-beige/90">
            We’re looking for professionals who share our passion for architectural excellence, construction interiors, and disciplined project delivery.
          </p>
        </div>
        ...
        <div className="mt-20 rounded-[32px] border border-white/10 bg-crown-rich/40 p-10 text-crown-beige shadow-glow sm:p-14">
          ...
          <ul className="mt-8 grid gap-5 text-sm leading-7 sm:grid-cols-2">
            ...
            <li className="rounded-3xl border border-white/10 bg-white/5 p-5">Luxury Interiors, Intelligent Space Planning & Creative Architectural Design.</li>
            <li className="rounded-3xl border border-white/10 bg-white/5 p-5">Understanding client requirements and delivering tailored professional solutions.</li>
            <li className="rounded-3xl border border-white/10 bg-white/5 p-5">Continuousely evolving with the latest design trends and innovations.</li>
          </ul>
        </div>
      </div>
    </section>
