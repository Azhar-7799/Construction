...
const LiveProjects = () => {
  ...
  return (
    <>
      <SEO
        title="Construction Interior & Turnkey Projects in Telangana | Crown Home Spaces"
      ...
      <section className="relative h-[70vh] min-h-[520px] overflow-hidden sm:h-[75vh] lg:h-[80vh]">
        ...
        <div className="relative mx-auto flex h-full max-w-7xl items-end px-4 pb-16 sm:px-6 lg:px-8">
          <div className="max-w-3xl rounded-[32px] border border-white/10 bg-black/40 p-8 shadow-glow backdrop-blur-xl">
            ...
            <p className="mt-6 text-base leading-8 text-crown-beige/90 sm:text-lg">A premium hero presentation of current projects and upcoming luxury properties from Crown Home Spaces, designed for discerning clients in Telangana and Hyderabad.</p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
            <div>
              ...
              <h1 className="mt-4 text-[clamp(2rem,5vw,3.75rem)] font-semibold text-white sm:text-[clamp(2.5rem,4vw,4.5rem)] lg:text-[clamp(3rem,3.5vw,5rem)]">Cinematic construction interior and turnkey project showcases from Telangana.</h1>
          ...
          <div className="space-y-6 rounded-[40px] border border-white/10 bg-black/40 p-8 shadow-glow backdrop-blur-xl">
            ...
            <div className="grid gap-4">
              ...
              <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
                ...
                <p className="mt-2 text-sm text-crown-beige/90">Local delivery across Telangana, Gachibowli, Jubilee Hills, Hitech City, and more.</p>
              </div>
            </div>
          </div>
        </div>
